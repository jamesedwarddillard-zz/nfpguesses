...
class TestReportReader(unittest.TestCase):
	...
	def testReportReading(self):
		...
		self.assertEqual(sept_2014_report.first_revision.month, "07")
		...
		self.assertEqual(sept_2014_report.second_revision.month, "06")
